...
/**
 * Represents a process launched by this process.
 * <br>
 * A shell process is launched using the Shell.process method.  The ShellProcess class is used to read data from stdout
 * and stderr.  There are also methods to write to stdin of the launched process.
 * <br>
 * The waitFor method can be used to wait for the subprocess to terminate.  The exitValue method can be used to determine if
 * the process has terminated.  The destroy method can be used to destroy the launched process.
 *
...
public class ShellProcess {
  ...
  public ShellProcess(Process javaProcess) {
