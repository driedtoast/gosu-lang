...
/**
 * A ProcessStart is used start processes.  There are wide range of methods on this class to start processes.
 * <br>
 * You can also use this class to control the environment and starting directory of the process.
 *
...
public class ProcessStarter {
  ...
  /**
   * The process built up will used CMD if this is a windows platform.  This is necessary because on windows certain
