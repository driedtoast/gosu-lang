...
public class IRClassBuilder extends IRFeatureBuilder<IRClassBuilder> {
  ...
  // AHK - 3/18/2010 - This is a pretty brutal hack, but if the class is defined in a child classloader it can often
  // lead to classloader hell
