...
public class IRBuilderMethods {
  ...
  public static IRMethodCallExpressionBuilder call( Method method, IRExpressionBuilder... args ) {
  ...
  public static IRMethodCallExpressionBuilder call( IRExpressionBuilder root, Method method, IRExpressionBuilder... args ) {
  ...
  public static List<IRExpressionBuilder> passArgs( Method m ) {
  ...
  public static List<IRExpressionBuilder> passArgs( Constructor cons ) {
    List<IRExpressionBuilder> args = new ArrayList<IRExpressionBuilder>();
