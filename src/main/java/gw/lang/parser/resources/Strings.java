...
/**
 * A resource bundle primarily for Strings. Maps static keys generated in
 * {@link Res} for typesafe, compile-time checked access to localizable Strings.
 *
 *  Copyright 2010 Guidewire Software, Inc.
 */
   ...
   static final Object[][] contents =
     {
       ...
       {Res.MSG_EXPECTING_OPERATOR_TO_FOLLOW_NEW_EXPRESSION.getKey(), "Incomplete Statement. Expecting operator to follow new expression."},
       ...
       {Res.MSG_EXPECTING_ARRAYTYPE_FOREACH.getKey(), "Expecting Array type after 'in' clause in \"for...in\" statement. Found: {0}"},
       ...
       {Res.MSG_NON_LITERAL_ARG_TO_JAVA_ANNOTATION.getKey(), "This argument is not a valid argument to a java annotation.  All arguments must be non-null literals, other annotations or arrays of these values."},
       {Res.MSG_MISPLACED_META_ANNOTATION.getKey(), "This annotation can only be used on an annotation class."},
       {Res.MSG_MISPLACED_ANNOTATION.getKey(), "This annotation can not be used on an annotation class."},
       ...
       {Res.MSG_AMBIGUOUS_METHOD_INVOCATION.getKey(), "This is an ambiguous function call.  The function with parameter types {0} will be called, \n" +
                                                      "but you should consider making this explicit by casting with 'as' expressions.  If you \n" +
                                                      "wish to call any of the following versions of the function you will have to \n" +
                                                      "explicitly cast the parameters to different types : " +
                                                      "{1}\n"},
       {Res.MSG_RETURN_VAL_FROM_VOID_FUNCTION.getKey(), "You are attempting to return a value from a void function."},
       {Res.MSG_BAD_ANONYMOUS_CLASS_DECLARATION.getKey(), "Only java and gosu types may be anonymously exteneded."},
       ...
       {Res.MSG_APPLICATION_MODIFIER_HAS_BEEN_DEPRECATED.getKey(), "The \"application\" modifier has been deprecated.  Use the gw.api.web.Scope.Application map instead." },
       {Res.MSG_SESSION_MODIFIER_HAS_BEEN_DEPRECATED.getKey(), "The \"session\" modifier has been deprecated.  Use the gw.api.web.Scope.Session map instead." },
       {Res.MSG_REQUEST_MODIFIER_HAS_BEEN_DEPRECATED.getKey(), "The \"request\" modifier has been deprecated.  Use the gw.api.web.Scope.Request map instead." },
       ...
       {Res.MSG_PACKAGE_RELATIVE_IMPORTS_CONSIDERED_HARMFUL.getKey(), "This is a package relative reference.  Please use the fully qualified name of the type instead." },
       ...
       {Res.WSDL_ENTITY_COLLECTION.getKey(), "Web Service cannot reference IEntityCollection as a parameter or a return type to an API method.  Instead, please try a strongly typed array. (e.g. entity.Contact[]). {1}"},
       ...
       {Res.WS_ERR_Annotation_Duplicate_Namespace.getKey(), "On {0} Namespace {1} already seen for {2} not usable for {3}"},
       ...
       {Res.WS_ERR_Can_Not_Marshal.getKey(), "Can not marshal type {0} for {1}"},
       ...
       {Res.WS_ERR_Export_No_Extends.getKey(), "An exportable class can not extend another class"},
       {Res.WS_ERR_Export_Not_Final.getKey(), "An exportable class must be final"},
       {Res.WS_ERR_Export_Not_WebService.getKey(), "A web service can not be an exportable class"},
