...
/**
 * A typesafe, compile-time checked mechanism for maintaining and accessing
...
public class Res
{
  ...
  public static final ResourceKey MSG_EXPECTING_OPERATOR_TO_FOLLOW_NEW_EXPRESSION = new ResourceKey( "MSG_EXPECTING_OPERATOR_TO_FOLLOW_NEW_EXPRESSION" );
  ...
  public static final ResourceKey MSG_USE_INTERVAL_ITERATION_INSTEAD = new ResourceKey( "MSG_USE_INTERVAL_ITERATION_INSTEAD" );
  ...
  public static final ResourceKey WSDL_ENTITY_COLLECTION = new ResourceKey("WSDL_ENTITY_COLLECTION");
  ...
  public static final ResourceKey MSG_PACKAGE_RELATIVE_IMPORTS_CONSIDERED_HARMFUL = new ResourceKey( "MSG_PACKAGE_RELATIVE_IMPORTS_CONSIDERED_HARMFUL" );
