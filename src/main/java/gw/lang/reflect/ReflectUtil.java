...
{
  public static Object construct( String typeName, Object... args )
  {
    ...
    {
      return constructorInfo.getConstructor().newInstance( coerceArgsIfNecessary( constructorInfo.getParameters(), args ) );
    }
    else
    {
  ...
  {
    ITypeInfo typeInfo = type.getTypeInfo();
    List<? extends IMethodInfo> methodInfos = typeInfo instanceof IRelativeTypeInfo ?
