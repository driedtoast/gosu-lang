...
/**
 * Class used to implement the List interface on the SimpleXmlNode element.  Modifications to this list will
 * result in setting or nulling out the parent pointer on the child elements.
 *
