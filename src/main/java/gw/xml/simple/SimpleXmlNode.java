...
/**
 * SimpleXmlNode represents a simplified XML parser.  It specifically does not handle namespaces, strips all prefixes
 * from element and attribute names, makes no attempt to preserve those prefixes, does no schema validation, and
